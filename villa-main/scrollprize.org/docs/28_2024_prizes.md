...
<head>
  ...
  <meta
    name="description"
    content="The 2024 Vesuvius Challenge prizes: a $200k Grand Prize to read 90% of four scrolls, plus automated segmentation, first letters, title, and progress prizes."
  />
...
This page has been archived: the 2024 prize cycle has concluded and submissions are closed. See [Winners](winners) for the results and [Prizes](prizes) for what is open today.

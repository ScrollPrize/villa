...
if __name__ == "__main__":
    ...
    computed_annotations = compute_relative_windings(
    ...
    pcl_json = annotations_to_pcl_json(computed_annotations)
    ...
    log.info(
        ...
        len(computed_annotations),
        len(set(a["patch_a"] for a in computed_annotations) | set(a["patch_b"] for a in computed_annotations)),
    )

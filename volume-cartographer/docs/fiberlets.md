...
compiler version, and build configuration are also part of producer identity;
cache directories generated by a different toolchain/configuration are likewise
separate and explicit cross-toolchain roots are rejected. During generation,

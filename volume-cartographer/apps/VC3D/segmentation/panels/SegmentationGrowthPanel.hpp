...
private:
    ...
    QSpinBox* _spinPatchParamSdir2dRadius{nullptr};
    QDoubleSpinBox* _spinPatchParamSdir2dWeight{nullptr};
    QDoubleSpinBox* _spinPatchParamSdir2dGlobalWeight{nullptr};
    QDoubleSpinBox* _spinPatchParamSdir2dCandidateMax{nullptr};
    QDoubleSpinBox* _spinPatchParamAreaMinRatio{nullptr};
    QDoubleSpinBox* _spinPatchParamAreaWeight{nullptr};
    QDoubleSpinBox* _spinPatchParamNonneighborMinRatio{nullptr};
    QSpinBox* _spinPatchParamNonneighborRadius{nullptr};
    ...
    int _patchSdir3dRadius{0};
    double _patchSdir3dWeight{0.0};
    double _patchSdir3dGlobalWeight{0.0};
    double _patchSdir3dCandidateMax{0.0};
    int _patchParamSdir2dRadius{0};
    double _patchParamSdir2dWeight{0.0};
    double _patchParamSdir2dGlobalWeight{0.0};
    double _patchParamSdir2dCandidateMax{0.0};
    double _patchParamAreaMinRatio{0.25};
    double _patchParamAreaWeight{2.0};
    double _patchParamNonneighborMinRatio{0.5};
    int _patchParamNonneighborRadius{4};

...
from tifxyz_label_transfer.core import Surface, SurfaceMapper
from tifxyz_label_transfer.prepare_canvas_offset_evidence import ZarrLevel
from tifxyz_label_transfer.self_render_tifxyz import (
    RawChunkSampler,
    _annotation_offsets,
    _canvas_shape_check,
...
class SourceCanvasMeasurementTests(unittest.TestCase):
    def test_shipped_max_can_approve_when_center_has_no_usable_tiles(
        ...
        with patch(
            "tifxyz_label_transfer.self_render_tifxyz.measure_render_shift",

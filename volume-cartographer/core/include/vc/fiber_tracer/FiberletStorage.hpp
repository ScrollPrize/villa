...
[[nodiscard]] std::vector<std::byte> serializeFiberletAnchors(const FiberletStorageCodecConfig& config, std::span<const FiberletStoredAnchor> anchors);

[[nodiscard]] std::vector<std::byte> serializeFiberletPrefixes(const FiberletStorageCodecConfig& config, std::span<const FiberletStoredPrefix> prefixes);

[[nodiscard]] std::vector<std::byte> serializeFiberletRoutes(const FiberletStorageCodecConfig& config, std::span<const FiberletStoredRoute> routes);

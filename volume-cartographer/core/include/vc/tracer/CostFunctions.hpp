...
struct NormalFitQualityWeightField {
    NormalFitQualityWeightField(std::unique_ptr<vc::zarr::Dataset>&& rms_ds,
                                std::unique_ptr<vc::zarr::Dataset>&& frac_ds,
                                float scale,
...
private:
    ...
    float _scale;
    std::unique_ptr<vc::zarr::Dataset> _rms_ds;
    std::unique_ptr<vc::zarr::Dataset> _frac_ds;

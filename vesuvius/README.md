...
| ----------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `vesuvius.surface_preflight`  | `surface_preflight`                | [fails closed](docs/surface-preflight.md) when a TIFXYZ surface is not structurally valid or safely paired with its Zarr/OME-Zarr CT volume                                                               |
...
| `vesuvius.find_largest_zarr_cube` | `scripts.find_largest_zarr_cube` | finds the largest chunk-aligned 3D cube for which every required Zarr v2 chunk is encoded; accepts arrays, OME-Zarr roots, and fiberlet groups                                                              |

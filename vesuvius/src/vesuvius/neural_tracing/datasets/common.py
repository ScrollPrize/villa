...
from vesuvius.data.chunk_cache import (
    DiskCacheStoreV2 as _DiskCacheStoreV2,
    DiskCacheStoreV3 as _DiskCacheStoreV3,
    DiskCacheStore as _DiskCacheStore,
    OfflineCacheMiss,
    ZarrCacheTraceStats,
...
def open_zarr(path, scale=None, auth_json_path=None, config=None):
    ...
    Remote paths (HTTP/S3) require ``volume_cache_dir`` in *config*: reads go
    through :class:`vesuvius.data.chunk_cache.DiskCacheStore`, which caches
    zarr chunks on disk across epochs and training runs.

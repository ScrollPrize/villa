...
FIBER_ZARRS=${FIBER_ZARRS:-/home/sean/Documents/volpkgs/s1_2um.volpkg/20260411134726-fibers-20260915212757-L1_masked}
FIBERS=${FIBERS:-/mnt/bigpc/spiral_dataset_working/fibers}
cd "$VES"
...
setsid nohup .venv/bin/python -u -m vesuvius.neural_tracing.fiber_follow.train \

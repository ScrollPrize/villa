...
def add_args(p: argparse.ArgumentParser) -> None:
	...
	g.add_argument("--unet-tile-size", type=int, default=512)
	g.add_argument("--unet-overlap", type=int, default=128)
	g.add_argument("--unet-border", type=int, default=0)
...
def load_fit_data(cfg: DataConfig, *, out_dir_base: str | None = None) -> fit_data.FitData:

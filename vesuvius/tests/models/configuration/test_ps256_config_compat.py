...
def test_ps128_pretrained_dino_pixelshuffle_medial_config_loads_and_builds():
    mgr = _load_mgr("src/vesuvius/models/configuration/single_task/ps128_pretrained_dino_pixelshuffle_medial.yaml")
    model = NetworkFromConfig(mgr)
...
def test_ps256_pretrained_dino_pixelshuffle_medial_config_loads_and_builds():
    mgr = _load_mgr("src/vesuvius/models/configuration/single_task/ps256_pretrained_dino_pixelshuffle_medial.yaml")
    model = NetworkFromConfig(mgr)

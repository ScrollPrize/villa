...
class DataConfig:
	...
	sparse_prefetch_backend: str                         # "cuda" or "python" streaming prefetcher
...
def add_args(p: argparse.ArgumentParser) -> None:
	...
	g.add_argument("--sparse-prefetch-backend", choices=("cuda", "python"), default="cuda",
		help="Sparse streaming prefetch backend: cuda computes missing chunks on GPU, python uses the old tensor path")
...
def from_args(args: argparse.Namespace) -> DataConfig:
	...
	return DataConfig(
		...
		sparse_prefetch_backend=str(getattr(args, "sparse_prefetch_backend", "cuda")),
	)

	...
	def _run_opt(*, si: int, label: str, stage: Stage, opt_cfg: OptSettings, data: fit_data.FitData3D) -> fit_data.FitData3D:
		...
		def _print_status(*, step_label: str, loss_val: float, tv: dict[str, float], pv: dict[str, float],
			...
			label_map = {
				...
				"snaps_rmax": "s_rmx",
				"snaps_tow": "s_tow",
				"snaps_raw_map_min": "s_amn",
				"snaps_raw_map_avg": "s_aav",
				"snaps_raw_map_max": "s_amx",
				"snaps_in_map_min": "s_imn",
				"snaps_in_map_avg": "s_iav",
				"snaps_in_map_max": "s_imx",
			...
			key_order = {
				...
				"snaps_rmax": 140,
				"snaps_tow": 141,
				"snaps_raw_map_min": 142,
				"snaps_raw_map_avg": 143,
				"snaps_raw_map_max": 144,
				"snaps_in_map_min": 145,
				"snaps_in_map_avg": 146,
				"snaps_in_map_max": 147,
				"snaps_dbg_iter": 148,
				"snaps_dbg_ring": 149,
				"snaps_dbg_grid": 150,
				"snaps_dbg_ori": 151,

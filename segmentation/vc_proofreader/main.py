...
# Morphology and distance transform utilities
try:
    # Fast EDT implementation (pip package 'edt') if available
    from edt import edt as fast_edt
except Exception:
    fast_edt = None

from scipy.ndimage import (
    distance_transform_edt as scipy_edt,
    binary_dilation,
    maximum_filter,
...
# --- Analysis widgets: components, extraction, DT, borders, thickness ---
...
def main():
    ...
    viewer.window.add_dock_widget(goto_z, name="Go To Z", area="right")
    ...
    # Analysis widgets for component extraction and measurements
    viewer.window.add_dock_widget(compute_components, name="Connected Components", area="right")
    viewer.window.add_dock_widget(extract_component, name="Extract Component", area="right")
    viewer.window.add_dock_widget(compute_distance_transform, name="Distance Transform", area="right")
    viewer.window.add_dock_widget(make_border_from_mask, name="Make Border", area="right")
    viewer.window.add_dock_widget(compute_thickness_from_dt_maxima, name="Thickness (DT Maxima)", area="right")
    viewer.window.add_dock_widget(compute_thickness_map, name="Thickness Map", area="right")

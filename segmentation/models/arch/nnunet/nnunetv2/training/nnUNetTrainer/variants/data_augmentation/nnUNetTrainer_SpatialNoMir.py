...
from nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerSkeletonRecall import nnUNetTrainerMedialSurfaceRecallNoMir
...
class nnUNetTrainer_SpatialMedSurfNoMir(nnUNetTrainerMedialSurfaceRecallNoMir):
    @staticmethod
    def get_training_transforms(
            patch_size: Union[np.ndarray, Tuple[int]],
            rotation_for_DA: RandomScalar,

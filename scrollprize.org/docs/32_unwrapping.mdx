...
We offered a 2024 prize for solving this problem. It was left unclaimed, and the work now continues through [Progress Prizes](prizes#progress-prizes), including VC3D and virtual-unwrapping improvements from the public wishlist.
...
All approaches rely also on the information about the scroll umbilicus. By early 2026, semi-automated VC3D workflows could extract substantial scroll surfaces much faster than fully manual tracing, but sheet switches and compressed regions remain major blockers to fully automated unwrapping.
...
This is a January 2025 virtual unwrapping attempt with Thaumato Anakalyptor on Scroll 5 (PHerc 172). For newer progress on PHerc 172, see the January 2026 update: [~70% of PHerc. 172 is now digitally unwrapped](https://scrollprize.substack.com/p/70-of-pherc-172-is-now-digitally).
...
Despite these advances, the problem is still unsolved. Current methods can unwrap large regions, but no method so far reliably fits the wanted surface throughout a damaged scroll without human correction.

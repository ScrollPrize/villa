...
- [ScrollAnchor](https://github.com/olgaiv39/scroll-anchor) by Olga Ivanova. CPU-first diagnostic toolkit for reviewing suspicious geometric and visual discontinuities in reconstructed papyrus surfaces. Includes separate 3D surface-and-volume checks, 2D render candidate analysis, tifxyz boundary diagnostics, reproducible review artifacts, and candidate-to-tifxyz mapping.

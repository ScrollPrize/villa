...
- [Proposed VC3D rendering and interaction fixes](https://github.com/ScrollPrize/villa/pulls?q=is%3Apr+author%3ALubuSeb) by Sebastien Andersson / LubuSeb (open for upstream review). Focused Volume Cartographer improvements proposed in open PRs for active-view inspection, active-plane seeding behavior, parallel tile rendering reliability, and optional `vc_render_tifxyz` normal-direction handling ([#1051](https://github.com/ScrollPrize/villa/pull/1051), [#1053](https://github.com/ScrollPrize/villa/pull/1053), [#1054](https://github.com/ScrollPrize/villa/pull/1054), [#1055](https://github.com/ScrollPrize/villa/pull/1055)). Validated with Dockerized VC3D/CTest suites.

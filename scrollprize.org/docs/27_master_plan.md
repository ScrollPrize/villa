...
* In 2025, (as of July 2025) while still automating unwrapping, the focus shifted to optimizing the scanning protocol, with the aim of X-ray imaging and reading the 300 extant scrolls, mostly in Naples. By pioneering cutting‑edge X-ray scanning techniques—such as tetra‑, hexa‑, and octa‑helical acquisitions—on the [BM18 beamline at ESRF](https://www.esrf.fr/home/UsersAndScience/Experiments/StructMaterials/BM18.html), we can now scan a large scroll at 9.2 µm pixel size in under two hours. This more than halves the scan time compared to our previous sessions, while also improving effective resolution. More than thirty scrolls have been scanned under varied setups, altering both resolution and contrast mechanisms. As of that snapshot, ink remained elusive in much of the new data. Nevertheless, we extracted the title from one of the “readable” unopened scrolls, confirming that the author was [Philodemus of Gadara](https://scrollprize.substack.com/p/60000-first-title-prize-awarded).
* 2026 update: higher-resolution scanning has since revealed [letters in PHerc. 1667 / Scroll 4](https://scrollprize.substack.com/p/finallyletters-in-scroll-4), and semi-automated unwrapping has extracted the lower [~70% of PHerc. 172 / Scroll 5](https://scrollprize.substack.com/p/70-of-pherc-172-is-now-digitally). The core goals remain unwrapping at scale and generalizable ink detection.
...
* Ink identification
  ...
  * Analysis of fragments suggests that when ink is neither metal‑rich nor “cracked,” higher‑resolution scans may be required to enhance the amount of signal in the data. This route remains active, especially after the Scroll 4 high-resolution scan revealed letters in regions that previously showed no convincing signal.

Improvements in both unwrapping at scale and ink identification remain the main goals of the current stage.

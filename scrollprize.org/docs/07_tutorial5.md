...
<head>
  ...
  <meta
    name="description"
    content="Vesuvius Challenge ink detection tutorial: how machine learning models find carbon ink in Herculaneum scroll surface volumes using infrared ground truth."
  />

...
* Starting point: [From Ash to Text](tech_blogpost) (the state of the pipeline), [Data](data), [Tutorials](tutorial)
</Admonition>
...
* Starting point: [From Ash to Text](tech_blogpost), [Segmentation tutorial](segmentation)
</Admonition>

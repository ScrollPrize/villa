...
Given our recent work on PHercParis4, and the flexibility/sparsity afforded by the spiral fit,  **we believe that the fastest way to unroll scrolls at scale is to develop methods for creating these that are as precise and fast enough to use at scale**

...
TRAINING_SCALARS = {
    ...
    "stitch_embedding_loss_weight": float,
    "stitch_embedding_model_config_path": object,
    "stitch_embedding_model_checkpoint_path": object,
    "stitch_embedding_downsample_factor": int,

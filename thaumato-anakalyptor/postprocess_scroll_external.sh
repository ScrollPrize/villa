...
if (( start_idx <= 5 )); then
  ...
  refine_cmd="while [[ -n \"\${CONDA_DEFAULT_ENV:-}\" ]]; do conda deactivate; done && echo \"Conda completely deactivated.\" && python3 -m ThaumatoAnakalyptor.pointcloud_mesh_refinement --mesh /workspace/experiments/1352_3600_5002/mesh_0.obj --downsample_ratio 0.075 --skip_meshing"

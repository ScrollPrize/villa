...
def worker_build_GT(args):
    ...
    def process_ply_files(ply_files):
        ...
        for i, ply_file_path in enumerate(ply_files):
            ...
            winding_angle_difference, winding_angles2, scene2, mesh2, percentage_valid = align_winding_angles(vertices1_spelufo, winding_angles1, mesh_gt_stuff, umbilicus_path, 15, gt_splitter, debug=False, verbose=False) # aling to GT mesh per point. # takes spelufo coordinate system
            if percentage_valid > 0.5:
                ...
                winding_angle_difference, winding_angles2, scene2, mesh2, percentage_valid = align_winding_angles(vertices1_spelufo, winding_angles1, mesh_gt_stuff, umbilicus_path, 210, gt_splitter, verbose=False) # aling to GT mesh per point. # takes spelufo coordinate system

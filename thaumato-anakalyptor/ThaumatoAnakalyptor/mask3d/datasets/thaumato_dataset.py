...
'''
Arguments with which the class was instantiated:
...
#inference_parameters = {'dataset_name': 'stpls3d', 'data_dir': 'data/processed/stpls3d', 'label_db_filepath': 'data/processed/stpls3d/label_database.yaml', 'color_mean_std': 'data/processed/stpls3d/color_mean_std.yaml', 'mode': 'test', 'add_colors': True, 'add_normals': False, 'add_raw_coordinates': True, 'add_instance': True, 'num_labels': 2, 'data_percent': 1.0, 'ignore_label': 255, 'volume_augmentations_path': None, 'image_augmentations_path': None, 'instance_oversampling': 0, 'place_around_existing': False, 'max_cut_region': 0, 'point_per_cut': 100, 'flip_in_center': False, 'noise_rate': 0.0, 'resample_points': 0.0, 'cache_data': True, 'add_unlabeled_pc': False, 'task': 'instance_segmentation', 'cropping': False, 'cropping_args': None, 'is_tta': False, 'crop_min_size': 20000, 'crop_length': 54, 'cropping_v1': False, 'reps_per_epoch': 1, 'area': 5, 'on_crops': True, 'eval_inner_core': 50.0, 'filter_out_classes': [0], 'label_offset': 1, 'add_clip': False, 'is_elastic_distortion': True, 'color_drop': 0.0}
inference_parameters_anywhere_fixed_location_mask3d = {'dataset_name': 'stpls3d', 'data_dir': 'ThaumatoAnakalyptor/mask3d/data/processed/stpls3d', 'label_db_filepath': 'ThaumatoAnakalyptor/mask3d/data/processed/stpls3d/label_database.yaml', 'color_mean_std': 'ThaumatoAnakalyptor/mask3d/data/processed/stpls3d/color_mean_std.yaml', 'mode': 'test', 'add_colors': True, 'add_normals': False, 'add_raw_coordinates': True, 'add_instance': True, 'num_labels': 2, 'data_percent': 1.0, 'ignore_label': 255, 'volume_augmentations_path': None, 'image_augmentations_path': None, 'instance_oversampling': 0, 'place_around_existing': False, 'max_cut_region': 0, 'point_per_cut': 100, 'flip_in_center': False, 'noise_rate': 0.0, 'resample_points': 0.0, 'cache_data': False, 'add_unlabeled_pc': False, 'task': 'instance_segmentation', 'cropping': False, 'cropping_args': None, 'is_tta': False, 'crop_min_size': 20000, 'crop_length': 54, 'cropping_v1': False, 'reps_per_epoch': 1, 'area': 5, 'on_crops': True, 'eval_inner_core': 50.0, 'filter_out_classes': [0], 'label_offset': 1, 'add_clip': False, 'is_elastic_distortion': True, 'color_drop': 0.0}

def Mask3DInference():
    return SemanticSegmentationInference(**inference_parameters_anywhere_fixed_location_mask3d)
        
class SemanticSegmentationInference():
    """Docstring for SemanticSegmentationInference."""
    ...
    def _select_correct_labels(self, labels, num_labels):
        ...
        if num_labels == number_of_all_labels or num_labels == number_of_all_labels - unlabeled_used:
            return labels

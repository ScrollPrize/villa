...
def show_winding_angle_relationship(base_path, umbilicus_path, mesh_path1, mesh_path2, max_distance, distance_threshold=100):
    ...
    generate_colored_mask_png(np.arange(len(uvs1[triangles_related_mask])), colors2[vertices_ids2], uvs1[triangles_related_mask], img1_size, image1_path)
    ...
    generate_colored_mask_png(np.arange(len(uvs1[triangles_related_mask])), colors1, uvs1[triangles_related_mask], img1_size, image1_path)
